const topClass = {
  ...
  project7: document.querySelector(".project7"),
...
const topId = {
  ...
  sectionProject7: document.querySelector("#project7"),
...
topClass.project7.addEventListener("click", function () {
  topId.sectionProject7.scrollIntoView({ behavior: "smooth", block: "center" });
});
...
tl.to(
  "h1",
  { duration: 0.2, className: "+=superShadow", top: "-=10px", ease: "power1.in", stagger: 0.3 },
  "start"
);
...
(function () {
  ...
  function initCircles() {
    ...
    for (var i = 0; i < n; i++) {
      ...
      circle.radius = r;
      circle.graphics
        .beginFill("rgb(" + color.r + "," + color.g + "," + color.b + ")")
        .drawCircle(0, 0, r);
      circle.x = x;
      circle.y = y;
      circles.push(circle);
